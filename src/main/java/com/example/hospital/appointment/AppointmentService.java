...
public class AppointmentService {
  ...
  /**
   * Crea e salva un nuovo appuntamento risolvendo i riferimenti al paziente e al medico tramite i
  ...
  public AppointmentResponse create(CreateAppointmentRequest request) {
    ...
    Appointment appointment =
        new Appointment(patient, doctor, request.appointmentDateTime(), request.status());
  ...
  /**
   * Controlla che lo stato futuro che si vuole impostare sull'appuntamento rispetti il flow
   * corretto
   *
