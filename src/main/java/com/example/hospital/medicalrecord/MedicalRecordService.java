...
public class MedicalRecordService {
  ...
  public MedicalRecordService(
      MedicalRecordRepository medicalRecordRepository, PatientRepository patientRepository) {
  ...
  private MedicalRecordResponse toResponse(MedicalRecord medicalRecord) {
    ...
    return new MedicalRecordResponse(medicalRecord.getId(), medicalRecord.getPatient().getId());
  }
}
